...
pub struct Clipper<'b, T: crate::core::System> {
...
impl<'b, T: crate::core::System> Clipper<'b, T> {
    pub fn new(contained: Box<dyn Widget<T> + 'b>) -> Self {
        Self {
            contained,
...
impl<'b, T: crate::core::System> Widget<T> for Clipper<'b, T> {
    fn update(
        &mut self,
