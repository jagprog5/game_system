...
fn do_example<'font_data, T: game_system::core::System<'font_data> + 'font_data>(
    ...
    let mut texture0 = Texture::new(&image_path, &mut system)?;
    let mut texture1 = Texture::new(&image_path, &mut system)?;
    let mut texture2 = Texture::new(&image_path, &mut system)?;
    let mut texture3 = Texture::new(&image_path, &mut system)?;
